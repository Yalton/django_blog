...
class PersonalData(models.Model):
    ...
    resume = models.FileField(
        upload_to='static/personaldata/resumes/%Y/%m/%d/', null=True, blank=True)
...
class Category(MPTTModel):
    ...
    category_image = models.ImageField(
        upload_to='uploads/categories/%Y/%m/%d/', null=True)
...
class Item(models.Model):
    ...
    item_image = models.ImageField(
        upload_to='uploads/items/%Y/%m/%d/', null=True)
...
class Notes(Post):
    notes = models.FileField(
        upload_to='uploads/notes/videos/%Y/%m/%d/', null=True, blank=True)
...
class Article(Post):
    main_image = models.ImageField(
        upload_to='uploads/articles/%Y/%m/%d/', null=True, blank=True,)
    ...
    sub_image = models.ImageField(
        upload_to='uploads/articles/sub_images/%Y/%m/%d/', null=True, blank=True,)
...
class Tutorial(Post):
    ...
    video = models.FileField(
        upload_to='uploads/tutorials/videos/%Y/%m/%d/', null=True, blank=True)
...
class TutorialField(models.Model):
    tutorial = models.ForeignKey(
        Tutorial, related_name='fields', null=True, blank=True, on_delete=models.CASCADE)
    title = models.CharField(max_length=100, null=True, blank=True,)
...
class TutorialFieldContent(models.Model):
    field = models.ForeignKey(TutorialField, related_name='content',
...
class TutorialFieldContentMedia(models.Model):
    field_content = models.ForeignKey(
        TutorialFieldContent, related_name='images', null=True, blank=True, on_delete=models.CASCADE)
    name = models.CharField(max_length=100, null=True, blank=True,)
    media = models.ImageField(
        upload_to='uploads/tutorials/fieldmedia/%Y/%m/%d/', null=True, blank=True,)
...
class Comment(models.Model):
    ...
    tutorial = models.ForeignKey(
        Tutorial, null=True, blank=True, on_delete=models.CASCADE)
